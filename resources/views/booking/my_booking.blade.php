    ...
    <section id="Header" class="w-full max-w-[1280px] mx-auto px-[52px] my-16">
        <div class="flex flex-col gap-16">
            <div class="flex flex-col items-center gap-1">
                <p class="font-bold text-[32px] leading-[48px] capitalize text-white">Find Your Booking</p>
                <p class="text-white">Enter the booking code from your email to check its status.</p>
            </div>
