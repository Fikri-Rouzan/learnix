                                ...
                                <div class="flex flex-col py-5 px-8 gap-8">
                                    <div class="flex items-center justify-between gap-8">
                                        ...
                                        <div class="flex flex-col gap-[2px] w-full">
                                            <p class="font-medium text-aktiv-grey">BCA Learnix Bank</p>
                                    ...
                                    <div class="flex items-center justify-between gap-8">
                                        ...
                                        <div class="flex flex-col gap-[2px] w-full">
                                            <p class="font-medium text-aktiv-grey">BNI Learnix Bank</p>
                                    ...
                                    <div class="flex items-center justify-between gap-8">
                                        ...
                                        <div class="flex flex-col gap-[2px] w-full">
                                            <p class="font-medium text-aktiv-grey">BRI Learnix Bank</p>
