<footer class="w-full p-[52px] bg-white">
    <div class="flex flex-col w-full max-w-[1176px] mx-auto gap-8">
        <div class="flex flex-col items-center gap-4">
            ...
            <p class="font-medium text-aktiv-grey">Learnix delivers high-quality education through dedicated,
                face-to-face learning experiences.</p>
        </div>
        <hr class="border-[#E6E7EB]">
        <div class="grid grid-cols-3 items-center">
            <p class="flex font-medium text-aktiv-grey"><span>Copyright &copy; <span id="year"></span>
                    Learnix</span></p>
