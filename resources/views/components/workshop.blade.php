...
<section id="Trending" class="w-full max-w-[1280px] mx-auto px-4 md:px-[52px] mt-16 md:mt-[100px]">
    <div class="flex flex-col gap-6 md:gap-8">
        <div class="flex flex-col gap-y-4 md:flex-row md:items-center md:justify-between">
            <h2 class="font-Neue-Plak-bold text-2xl md:text-[32px] leading-tight md:leading-[44.54px] capitalize">
                Check out the hottest workshops
                <br class="hidden md:block"> trending this week 🔥
            </h2>
            <a href="#"
                            ...
                            <div class="card-detail flex flex-col gap-2">
                                <div class="flex items-center gap-3">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="font-medium text-sm md:text-base text-aktiv-grey">
